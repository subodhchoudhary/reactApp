...
const SearchSubProgram = forwardRef((props, ref) => {
                                ...
                                <div className="top-head">
                                    ...
                                    <div className="col-md-6 col-sm-6 col-xs-6">
                                        <ul className="nav navbar-right panel_toolbox">
                                            <li>
                                                <a className="disableusercontrol" onClick={props. AddSubProgramFunction }>
                                                    Add Customer
                                                </a>
                                            </li>
                                        </ul>
                        ...
                        <div className="x_content">
                            ...
                            <div className="row form-group">
                                <div className="col-md-2">
                                    <label className="control-label from-txt">Program Id:</label>
                                </div>
                                ...
                                <div className="col-md-3">
                                    <input type="text" className="form-control" name='subprogram_cd' onChange={onChangeFunction} />
                                </div>
                                <div className="col-md-1"></div>
                            </div>
                            ...
                            <div className="row">
                                <div className="col-md-12 text-center">
                                    <a onClick={props.SearchSubProgramFunction} className="expdbutton btnSearch mr-2" >
                                        Search
                                    </a>
...
export default SearchSubProgram ;
