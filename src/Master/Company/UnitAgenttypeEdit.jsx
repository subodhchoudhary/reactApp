...
const UnitAgenttypeEdit = (props) => {

    const [postUserData, setPostUserData] = useState({
        id: props.data.unitagentResponses[0].id,
        unit_type_cd: props.data.unitagentResponses[0].unit_type_cd,
        agent_type_cd: props.data.unitagentResponses[0].agent_type_cd,
        remarks: props.data.unitagentResponses[0].remarks,
    });

    
    const { id, unit_type_cd, agent_type_cd, remarks } = postUserData;
    ...
    const updateUserData = () => {
        ...
        const apiAndUrl = 'UnitAgentType/UnitAgentType/' + id;
          ...
          <div className="x_content">
            ...
            <div className="row form-group">
              ...
              <div className="col-md-3">
                                  <input type="text" className="form-control" value={unit_type_cd} readOnly />
              </div>
...
export default UnitAgenttypeEdit;
