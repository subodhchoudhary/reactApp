...
const FranchiseSearch =forwardRef((props, ref)=> {
          ...
          <div className="x_panel boxshadow">
                ...
                <div className="top-head">
                  ...
                  <div className="col-md-6 col-sm-6 col-xs-6">
                    <ul className="nav navbar-right panel_toolbox">
                      <li>
                        <a className="disableusercontrol" onClick={props.AddFranchiseFunction} >
                          Add Customer
                        </a>
                      </li>
                    </ul>
            ...
            <div className="x_content">
              ...
              <div className="row form-group">
                ...
                <div className="col-md-3">
                  <input type="text" className="form-control" name='franchise' onChange={onChangeFunction} />
                </div>
                <div className="col-md-1"></div>
              </div>
              ...
              <div className="row">
                <div className="col-md-12 text-center">
                  <a
                    ...
                    onClick={props.FranchiseSearchFunction}
