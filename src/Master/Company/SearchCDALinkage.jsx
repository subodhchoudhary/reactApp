...
const SearchCDALinkage = forwardRef((props, ref) => {
                                ...
                                <div className="top-head">
                                    ...
                                    <div className="col-md-6 col-sm-6 col-xs-6">
                                        <ul className="nav navbar-right panel_toolbox">
                                            <li>
                                                <a className="disableusercontrol" onClick={props.AddCDALinkageFunction}>
                                                    Add Customer
                                                </a>
                                            </li>
                                        </ul>
                        ...
                        <div className="x_content">
                            ...
                            <div className="row">
                                <div className="col-md-12 text-center">
                                    <a className="expdbutton btnSearch mr-2" onClick={props.SearchCDALinkageFunction} >
                                        Search
                                    </a>
...
export default SearchCDALinkage;
