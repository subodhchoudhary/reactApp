...
function Franchise(props) {
  ...
  const [PostFranchiseData, setPostFranchiseData] = useState(
    {
    ...
    const onInputchange = (e) => {
        ...
        setPostFranchiseData({ ...PostFranchiseData, [name]: name === 'franchise_rank' ? parseInt(value) : value });
      }
    
     
    const AddFranchiseData = () => {
        const path = "Franchise/Franchise";

        const myReturnResData = AddUserFunction(path, PostFranchiseData)
          ...
          <div className="x_panel boxshadow">
            ...
            <div className="x_content">
              ...
              <div className="row form-group">
                ...
                <div className="col-md-3">
                  <input type="text" className="form-control" name="franchise" onChange={onInputchange} />
                </div>
                <div className="col-md-1"></div>
              </div>
              ...
              <div className="row form-group">
                ...
                <div className="col-md-3">
                <input type="text" className="form-control" name="franchise_rank" onChange={onInputchange} />
                </div>
                <div className="col-md-1"></div>
                <div className="col-md-2">
                  <label className="control-label from-txt">
              ...
              <div className="row form-group">
                <div className="row">
                  <div className="col-md-12 text-center">
                    <a onClick={AddFranchiseData} className="expdbutton btnSearch mr-2" >
                      Add
                    </a>
                    <a onClick={props.AddFranchiseBackBtn} className="expdbutton btnback mr-2" >
                      Back
                    </a>
                  </div>
                </div>
