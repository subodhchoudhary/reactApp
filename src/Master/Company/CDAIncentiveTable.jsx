...
function CDAIncentiveTable(props) {
    ...
    const deleteUserDataById = (id, incentive_type) => {
        const apiAndId = 'CDAIncentive/CDAIncentive/' + id
        ...
        if (window.confirm("Are You Sure Want To Delete")) {
            ...
            returnStatus.then((returnSt) => {
                if (returnSt === 200) {
                    toast.success("Id = " + id + "Incentive Type  = " + incentive_type + " is Deleted", { position: toast.POSITION.TOP_CENTER });
                }
            })
    ...
    const updateUserDataById = (id) => {
        ...
        props.UpdateCDAIncentiveDataFun('CDAIncentive/CDAIncentive?id=' + id)
    }

    const ViewUSerData = (id) => {
        props.ViewCDAIncentiveBtnFunction('CDAIncentive/CDAIncentive?id=' + id);
    }
  return (
    <>
                      ...
                      <div className="form-group" id="">
                          <div className="form-group x_content">
                              <table className="display w-100 DataTbl">
                                  ...
                                  <tbody>
                                      {
                                          props.data.cDAIncentiveresponse.map(
                                              propsUserData => (
                                                  ...
                                                  <tr key={propsUserData.id}>
                                                      ...
                                                      <td>
                                                          <a onClick={() => deleteUserDataById(propsUserData.id, propsUserData.incentive_type)}>
